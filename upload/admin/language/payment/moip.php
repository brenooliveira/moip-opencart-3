...
//Text
$_['text_Moip']            = '<img src="view/image/payment/moip.png" />';
...
$_['help_email']                = 'E-mail do Moip';
$_['help_token']                = 'Token de Segurança. Caso não tenha entre em contato com o suporte do Moip';
$_['help_modo_teste']           = 'É obrigatório que a CONTA TESTE seja qualquer-coisa@SANDBOX.Moip.COM.BR';
...
$_['help_aguardando_pagamento'] = 'O comprador iniciou a transação, mas até o momento o Moip não recebeu nenhuma informação sobre o pagamento.';
$_['help_analise']              = 'O comprador optou por pagar com um cartão de crédito e o Moip está analisando o risco da transação.';
$_['help_pago']                 = 'A transação foi paga pelo comprador e o Moip já recebeu uma confirmação da instituição financeira responsável pelo processamento.';
